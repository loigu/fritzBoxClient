...
public class FritzBoxMd5 {
	...
	private static String[] hexArray = { "00", "01", "02", "03", "04", "05", "06", "07", "08", "09", "0a", "0b", "0c",
	...
	public static String getResponseDigest(String challengeStr, String password) throws NoSuchAlgorithmException {
		return md5Hex(new StringBuilder(challengeStr).append("-").append(makeDots(password)).toString().getBytes());
	}
